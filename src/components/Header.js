          ...
          {/* <div>
            <ul className="flex items-center justify-between flex-wrap">
              <li><button onClick={handlePrint}
                  ...
                  hover:text-gray-500 transistion-all duration-300">
                  Print
                  </button>
              </li>
              <li className='mx-2'><button className="bg-blue-500 text-white font-bold
                   py-2 px-8 rounded shadow border-2
              ...
              <li><button className="bg-green-500 text-white font-bold
                   py-2 px-8 rounded shadow border-2
                   border-green-500 hover:bg-transparent
                   hover:text-green-500 transistion-all duration-300">
                   Send
                   </button>
              </li>
            </ul>
